<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/adminformstyleV2.css" />
...
<body>
  ...
  <div class="container">
    ...
    <div class="login-content">
      <form id="vaccinationForm" action="api/process-form.php" method="post">
        ...
        <a href="admindashboard.php" class="btn-nodesign">Go back</a>
      </form>
    </div>
  </div>
  ...
  <script>
        ...
        if (event.deltaMode === 0) {
            ...
            window.scrollBy({
                top: event.deltaY * 2,  // Adjust the multiplier (2) to speed up the scroll
                behavior: 'smooth'
            });
        }
        }, { passive: false });
